...
public final class AnalyticsEventName {
    ...
    public static final Set<String> OFFICIAL = Set.of(
            "portal_landing_viewed", "store_cta_clicked",
            "app_install_attributed", "install_referrer_unavailable",
    ...
    public static boolean requiresSession(String value) {
        return !Set.of(
                "portal_landing_viewed", "app_install_attributed",
                "install_referrer_unavailable", "app_opened", "error_occurred"
        ).contains(value);
    }
}
