...
public record QuestaoWebResponse(
        String idQuestion,
        String enunciado,
        Long enunciadoId,
        String questao,
        String alternativas,
        String questaoImagemConteudo,
        String questaoImagemJson,
        Long textoApoioId,
    ...
    public static QuestaoWebResponse fromEntity(Questao q) {
        ...
        return new QuestaoWebResponse(
                q.getIdQuestion(),
                q.getEnunciado(),
                q.getEnunciadoCatalogo() != null ? q.getEnunciadoCatalogo().getId() : null,
                q.getQuestao(),
                q.getAlternativas(),
                q.getQuestaoImagemConteudo(),
                q.getQuestaoImagemJson(),
                textoApoioId,
                textoApoioTitulo,
                textoApoioConteudo,
                textoApoioTipo,
