...
public record ConteudoPortalResponse(
        ...
        String instagramLegenda,
        String instagramHashtags,
        ConteudoPortal.InstagramStatus instagramStatus,
        String instagramMediaId,
        OffsetDateTime instagramPublicadoEm,
        String instagramUltimaFalha,
        String autorNome,
        String revisadoPor,
    ...
    public static ConteudoPortalResponse fromEntity(ConteudoPortal conteudo) {
        return new ConteudoPortalResponse(
                ...
                conteudo.getInstagramLegenda(),
                conteudo.getInstagramHashtags(),
                conteudo.getInstagramStatus(),
                conteudo.getInstagramMediaId(),
                conteudo.getInstagramPublicadoEm(),
                conteudo.getInstagramUltimaFalha(),
